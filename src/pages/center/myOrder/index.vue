    ...
    <div class="like">
      ...
      <ul class="like-list">
        <li class="likeItem">
          ...
          <div class="attr">
            <em>使用周期两年DELL戴尔Ins 15MR-7528SS 15英寸 银色 笔记本【全校可送】</em>
          </div>
          <div class="price">
            <em>¥</em>
            <i>2699.00</i>
          </div>
          <div class="commit">5人想要</div>
        </li>
        <li class="likeItem">
          <div class="p-img">
            <img src="../images/itemlike02.png" />
          </div>
          <div class="attr">宿舍用九成新小功率锅</div>
          <div class="price">
            <em>¥</em>
            <i>88.00</i>
          </div>
          <div class="commit">35人想要</div>
        </li>
        <li class="likeItem">
          <div class="p-img">
            <img src="../images/itemlike03.png" />
          </div>
          <div class="attr">使用一年基本无大问题iPhonex可送货上门</div>
          <div class="price">
            <em>¥</em>
            <i>3088.00</i>
          </div>
          <div class="commit">1人想要</div>
        </li>
        <li class="likeItem">
          <div class="p-img">
            <img src="../images/itemlike04.png" />
          </div>
          <div class="attr">插座宿舍用全新仅拆封【枫园自提】</div>
          <div class="price">
            <em>¥</em>
            <i>48.00</i>
          </div>
          <div class="commit">12人想要</div>
        </li>
      </ul>
    </div>
  </div>
