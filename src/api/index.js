...
export const reqTest = () =>localrequest({url:'/child1/findByName?fathername=学年',method:'get'});
//获取一级菜单
export const reqfirst = () => localrequest({url: '/init1',method:'get'})
export const reqvalues = (child) => localrequest({url: `/initvalue?formname=${child}`,method:'get'});
export const getList1 = () => localrequest({url: `/get-all-name`});
export const getList2 = (formname) => localrequest({url: `/get-second-name?formname=${formname}`,method:'get'});
export const getList3 = (formname,id) => localrequest({url: `/get-third-name?formname=${formname}&secondId=${id}`,method:'get'});